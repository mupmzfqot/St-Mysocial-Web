...
watch(
    search, debounce(
        (q) => router.get(route('most-comment-posts'), { search: q }, { preserveState: true }), 500
    )
);
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                            ...
                            <tr v-for="post in posts.data" key="user.id" class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                                ...
                                <td class="size-px whitespace-nowrap align-top text-center">
                                    ...
                                    <div v-else class="text-sm text-gray-500 mt-2">No media</div>
                                </td>
                                <td class="size-px whitespace-nowrap align-top text-center">
                                    <a class="block mt-2" href="#">
                                        <span class="text-sm text-gray-600 dark:text-neutral-400">{{ post.comments_count }}</span>
                                    </a>
                                </td>
                            </tr>
                            </tbody>
