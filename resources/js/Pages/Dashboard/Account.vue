...
watch(
    search, debounce(
        (q) => router.get(route('account', {type: props.type}), { search: q }, { preserveState: true }), 500
    )
);
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-900 dark:border-neutral-700">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                            ...
                            <tr v-for="user in users.data" key="user.id" class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                                ...
                                <td class="size-px whitespace-nowrap align-middle">
                                    <Link :href="route('user.profile', user.id)" class="text-gray-600 text-sm font-medium px-2 hover:text-blue-600" type="button">
                                        Go to Account
                                    </Link>
                                </td>
