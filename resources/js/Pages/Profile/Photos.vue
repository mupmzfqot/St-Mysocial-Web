                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-900 dark:border-neutral-700">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                            ...
                            <tr v-for="photo in photos.data" key="user.id" class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                                ...
                                <td class="size-px whitespace-nowrap align-top">
                                    <a class="block p-6" href="#">
                                        <img :src="photo.media[0].original_url" class="object-scale-down size-20" alt="photo">
                                    </a>
                                </td>
                                <td class="size-px whitespace-nowrap align-top">
                                    <a class="block p-6" href="#">
                                        <span class="text-sm text-gray-600 dark:text-neutral-400">{{ photo.media[0].created_at }}</span>
                                    </a>
                                </td>
