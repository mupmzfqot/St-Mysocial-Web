...
<template>
    ...
    <div class="absolute top-3 end-5" style="z-index: 1000">
        ...
        <div id="dismiss-alert" v-if="$page.props.flash.success" class="hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 bg-teal-50  border-2 border-teal-500 rounded-lg p-4 dark:bg-teal-800/30 dark:bg-teal-800/10 dark:border-teal-900 dark:text-teal-500" role="alert" tabindex="-1" aria-labelledby="hs-dismiss-button-label">
            <div class="flex">
                <div class="shrink-0">
